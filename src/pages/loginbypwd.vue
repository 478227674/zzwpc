  ...
  export default {
    ...
    methods:{
      ...
      loginNowFn(){
        ...
        this.http.post('/dir/userLogin',{userPhone:this.userPhone,userPwd:this.userPwd,loginType:1}).then(res=>{
          if(res.code == 0){
            this.$message({
              showClose: true,
              message: '登录成功',
            ...
            //     window.location.replace('https://www.zz1819.com/sys/#/');
            //   }else{
            //     window.open('https://www.zz1819.com/sys/#/');
            //   }
            // },1500)
          }else{
            this.refreshCode();
