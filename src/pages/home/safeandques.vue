  ...
  <div class="hello" style="background: #f5f5f5">
    ...
    <div class="pc-center news-detail-box">
      <div class="news-content-box">
        ...
        <div class="news-time">{{mdata.createTime}}</div>
        <div class="news-content" v-html="mdata.newDesc">
      ...
      <div class="news-list-other">
        ...
        <div class="hot-product">
          <div class="hot-title-r">
            课程推荐
          </div>
          <div class="hot-class-list" style="padding: 0;background: #fff;">
            <div  @click="openProductDetail(item)"  v-for="item in timeProList" class="hot-class-detail">
...
<script>
  export default {
    ...
    methods:{
      ...
      //获取消息详情
      getNewsDetail(){
        this.http.post('/dir/new/queryNewList',{newId:this.newsId}).then(res=>{
          if(res.code == 0){
            if(res.data.list.length > 0){
              res.data.list[0].createTime = this.formatTimeToDay(res.data.list[0].createTime)
